...
const locations = [
  ...
  {
    address: 'Piccadilly Gardens - Wednesdays 17:00pm',
  ...
  {
    address: 'Manchester Central Library - Thurdays 18:00pm',
  ...
  {
    address: 'Heaton Park, Manchester - Saturdays 12:00pm ',
  ...
  {
    address: 'MediaCityUK, Salford - Sundays 12:00pm',
        ...
        <div className="column">
          <div className="text-container">
            ...
            <p>
              ...
              donate, reserve, and stop food waste today. Make note of our drop off locations and
              times, when donating choose your closest and easiest location. The easy we can share
              and donate, the more we can make a change.
            </p>
          </div>
        </div>
      </div>
